...
- **引用格式**：APA / ACM
- **计划确认**：开启后，大纲生成完毕会暂停并请你确认再撰写；与澄清门禁 outline_confirm 联动
...
属于 **澄清门禁**：首轮主题不清、检索零命中、或你开启了 **计划确认**。按提示补充说明，或输入取消/确认类短句继续。

## 左侧「抓取网页全文」和阶段里的「抓取网页」不一样？

工具步骤用完整文案（便于区分 MOM 制造 vs ML）；阶段时间线沿用 DAG 短标签，含义相同。
