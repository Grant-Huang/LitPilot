...
class TursoTaskStore(TaskStore):
    ...
    def _load_record(self, task_id: str) -> TaskRecord | None:
        row = self._conn.execute(
            """
            SELECT id, session_id, message, fetch_urls_json, status, progress, stage,
                   error, cancel_requested, worker_id, started_at, finished_at, updated_at
        ...
        *,
        ...
        self._conn.execute(
            ...
            INSERT INTO literature_tasks (
                id, session_id, message, fetch_urls_json, status, progress, stage,
                error, cancel_requested, worker_id, started_at, finished_at, updated_at
